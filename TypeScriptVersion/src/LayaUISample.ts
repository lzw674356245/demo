...
class LayaUISample {
	/**资源数组*/
	assetArr:any=[{url: "res/atlas/comp.json", type: Laya.Loader.ATLAS},
									{url: "comp/cake.png"},
	...
	/**打开指定的UI */
	onOpenUI(uiName:string):void{
		//根据指定的UI名称实例化UI
		var openUI:any;
		var UIClass:any=Laya.ClassUtils.getClass(uiName+"View");
		...
		if(openUI instanceof Laya.Dialog) return;
		//设置位置
		openUI.pos(250,80);
		//加载新UI到舞台
